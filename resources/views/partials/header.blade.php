    ...
    <div class="main-header">
        <div class="header-container">
            ...
            <a href="{{ url('/') }}" class="logo">
                <img src="{{ asset('assets/logos/logo.webp') }}" class="site-logo">
            </a>

            <nav class="main-nav">
                <ul>
                    <li><a href="{{ url('/#hero') }}" class="hover-underline">Home</a></li>
                    <li><a href="{{ url('/#about-us') }}" class="hover-underline">About</a></li>
                    <li><a href="{{ url('/services') }}" class="hover-underline">Services</a></li>
                    <li><a href="{{ url('/vacancies') }}" class="hover-underline">Vacancies</a></li>
                    <li><a href="{{ url('/domestic') }}" class="hover-underline">Domestic Cleaning</a></li>
                    <li><a href="{{ url('/#contact-us') }}" class="hover-underline">Contact</a></li>
                </ul>
            </nav>
    ...
    <div class="mobile-header">
        ...
        <nav class="mobile-nav">
            ...
            <ul>
                ...
                <li><a href="{{ url('/domestic') }}">Domestic Cleaning</a></li>
